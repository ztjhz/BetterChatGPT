  ...
  return (
    ...
    >
      <div className='flex h-full w-full items-center justify-center'>
        <div
          className={`${dialogClassName} flex w-full transform flex-col  overflow-hidden rounded-xl bg-gray-850 text-left align-middle shadow-xl transition-all md:max-w-md `}
        >
