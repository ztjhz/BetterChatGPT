      ...
      {({ open }) => (
        <>
          <div className="relative">
            <Listbox.Button className="relative w-full cursor-default rounded-md bg-bg-100 py-1.5 pl-3 pr-3 md:pr-10 text-left text-white sm:text-sm sm:leading-6">
              <span className="flex items-center">
                ...
                <span className="ml-3 hidden md:block truncate">{selected}</span>
              </span>
              <span className="pointer-events-none absolute inset-y-0 right-0 ml-3  items-center pr-2 hidden md:flex">
            ...
            <Transition
              ...
              leaveTo="opacity-0"
            >
              <Listbox.Options className="absolute z-10 mt-1 max-h-56 w-fit md:w-full overflow-auto rounded-md bg-gray-850 py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
                {langs.map((lang) => (
                  <Listbox.Option
                    key={lang.id}
                    className={({ active }) =>
